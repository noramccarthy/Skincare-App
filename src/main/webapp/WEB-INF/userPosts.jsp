...
<body>
	<div class="flex-container">
		<nav class="navbar navbar-inverse p-3">
			<div class="container-fluid">
				...
				<ul class="nav navbar-nav navbar-right d-flex flex-row">
					<div class="dropdown">
						<button class="btn optionButton dropdown-toggle dropdown" type="button" data-toggle="dropdown" aria-expanded="false">
							Options
						</button>
		...
		<h3 class="d-flex justify-content-center m-3">Your Reviews</h3>
		...
		<div class="row gx-4 p-3">
			...
			<div class="col-10">
				<div class="table-responsive">
					<div class="table p-2">
						<table class="col-12" style="line-height: 3.5">
							<thead>
								<tr>
