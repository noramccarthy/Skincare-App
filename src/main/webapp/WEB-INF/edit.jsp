...
<body>
    <div class="flex-container">
        ...
        <div class="p-4">
            <form:form action="/edit/${updatedProduct.id}" method="POST" modelAttribute="updatedProduct" class="form-group p-3">
                ...
                <div class="d-flex justify-content-between mt-2">
                    ...
                    <a href="/${updatedProduct.id}/delete" class="btn viewButton">Delete Review</a>
                </div>
                    <a href="/dashboard/pages/1" class="btn viewButton mt-3">Cancel</a>
                <div>
