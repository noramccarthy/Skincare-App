                    ...
                    <div class="card-body px-4 py-5 px-md-5">
                        <form:form action="/register" method="POST" modelAttribute="newUser">
                            ...
                            <div class="form-outline mb-4">
                                    <form:input path="username" type="text" id="form3Example1" class="form-control" />
                                    <form:label path="username" class="form-label" for="form3Example1">Username</form:label>
                            </div>
                            ...
                            <div class="form-outline mb-4">
                                ...
                                <form:label path="confirmPassword" class="form-label" for="form3Example4">Confirm Password</form:label>
                            </div>
