...
<body>
    <div class="flex-container">
				...
				<ul class="nav navbar-nav">
					<div class="dropdown">
						...
						<ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="/dashboard/pages/1">Dashboard</a></li>
		...
		<div class="row gx-4 p-3">
			...
			<div class="col-10">
				<h3> Review of <c:out value="${product.name}"></c:out> by
					<c:out value="${product.brand}"></c:out>
				</h3>
	
				<p class="mb-5">
					Reviewed by: <c:out value="${product.submittedBy.username}"/>
				</p>
	
				<p><strong><c:out value="${product.submittedBy.username}"/> paid </strong>$<c:out value="${product.price}"/></p>
				<p><strong>This product is great for:</strong> <c:out value="${product.concern}"></c:out></p>
				<p><strong><c:out value="${product.submittedBy.username}"/>'s Skin Type:</strong> <c:out value="${product.skin}"></c:out></p>
				<p><strong><c:out value="${product.submittedBy.username}"/>'s Thoughts:</strong> <c:out value="${product.description}"/></p>
				<p><strong><c:out value="${product.submittedBy.username}"/>'s Rating:</strong> <c:out value="${product.rating}"/></p>
		
				<div class="d-flex flex-row">
					<c:if test = "${product.submittedBy.id == userID}">
						<p>You posted this review!</p> &nbsp
						<p><a href="/edit/${product.id}">Wish to edit it?</a></p>
					</c:if>
				</div>
			</div>
			<p><a href="/dashboard/pages/1" class="btn viewButton float-end">Back to Dashboard</a></p>
    </div>
</body>
</html>